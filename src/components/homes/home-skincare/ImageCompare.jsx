    ...
    <section className="flat-spacing-3">
      <div className="container">
        <div className="flat-title wow fadeInUp">
          <h4 className="title">Before &amp; After: Reveal Your Radiance</h4>
        </div>
        <div
          className="img-viewer-compare-wrap wow fadeInUp"
          style={{ position: "relative" }}
          data-wow-delay="0s"
        >
          <div id="image-compare" className="image-compare">
            <ReactCompareSlider
              itemOne={
                <ReactCompareSliderImage
                  src="/images/section/skincare-before.jpg"
                  srcSet="/images/section/skincare-before.jpg"
                  alt="Image one"
                />
              }
              itemTwo={
                <ReactCompareSliderImage
                  src="/images/section/skincare-after.jpg"
                  srcSet="/images/section/skincare-after.jpg"
                  alt="Image two"
                />
              }
            />
        ...
        >
          <SwiperSlide className="swiper-slide">
            <div className="tf-icon-box style-lg wow fadeInLeft">
              <svg
                width={65}
                height={64}
                viewBox="0 0 65 64"
          ...
          <SwiperSlide className="swiper-slide">
            <div
              className="tf-icon-box style-lg wow fadeInLeft"
              data-wow-delay="0.1s"
            >
              <svg
                width={64}
          ...
          <div className="d-flex d-xl-none style-white sw-dot-default sw-pagination-iconbox justify-content-center" />
        </Swiper>
      </div>
    </section>
  );
